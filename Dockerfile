...
ENV CACHE_PATH=/app/cache \
    ...
    ENABLED_PLUGINS=dyyjpro,duoduo,feikuai,gaoqing888,gying,hunhepan,ikantv,jutoushe,kkv,lingjisp,lou1,melost,nyaa,ouge,panlian,qqpd,quark4k,quarksoo,quarktv,qupanshe,sousou,thepiratebay,wanou,weibo,xb6v,xiaozhang,yunso,zxzj,miosou,ting77,libvio,dy4k,xiaoyu \
    AUTH_ENABLED=false \
